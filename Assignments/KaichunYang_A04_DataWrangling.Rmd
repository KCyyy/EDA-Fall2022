...
#summary can give us enough information of the datasets
summary(EPA_O3_2018)
summary(EPA_O3_2019)
...
#4
EPA_O3_2018_S <- select(EPA_O3_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
EPA_O3_2019_S <- select(EPA_O3_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
#6
write.csv(EPA_O3_2018_S, row.names = FALSE, file = "E:/EDA-Fall2022/Data/Raw/EPAair_O3_NC2018_processed.csv")
write.csv(EPA_O3_2019_S, row.names = FALSE, file = "E:/EDA-Fall2022/Data/Raw/EPAair_O3_NC2019_processed.csv")
...
#7
EPA_data <- 
  rbind(EPA_O3_2018_S, EPA_O3_2019_S, EPA_PM25_2018_s, EPA_PM25_2019_s)
...
#11
write.csv(EPA_data_3, row.names = FALSE, file = "E:/EDA-Fall2022/Data/Raw/EPAair_O3_PM25_NC1718_Processed.csv")
...
> Answer: 
na.omit command is designed to omit rows based on all columns of a data object.
