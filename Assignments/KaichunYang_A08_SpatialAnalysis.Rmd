...
Lan_2 <- county$NAME[Lancaster,]

# map0 = ggplot() + 
#   geom_sf(data = Lan)
# map0
# 
# Lan_centroids <- st_centroid(Lan)
# map1 <- map0 + geom_sf(data = Lan_centroids, color = 'blue')
# map1
# 
# Lan_centroids_2km <- st_buffer(Lan_centroids, 2000)
# map2 <- map1 + geom_sf(data = Lan_centroids_2km, color = 'orange', fill=NA)
# map2
# 
# Lan_in2km <- st_buffer(Lan, -2000)
# map3 <- map0 + geom_sf(data = Lan_in2km, color = 'green', fill=NA)
# map3

#23 Select gages within the selected county
gage_ht_Lan <- gage_ht_nadrop %>%
  filter(st_intersects(x = ., y = Lan, sparse = FALSE))
